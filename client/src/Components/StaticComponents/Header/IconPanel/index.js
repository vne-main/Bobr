...
const IconPanel = (user) => {

    const [openSettings, changeSettings] = useState(false);
    const [openBugReport, changeBugReport] = useState(false);
    ...
    return (
        <div className="header__icon_panel">
            ...
            >
                ...
                <ModalBugReport open={openBugReport}/>
            </div>
