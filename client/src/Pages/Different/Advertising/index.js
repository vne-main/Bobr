...
const Advertising = () => {
  useEffect(() => {
    changePage(PAGES_URL.advertising);
  }, []);
  const rate = [
    {
      ...
      price: '25000',
      text:
        'Добавление вашего продукта во вкладку "Спонсоры Бобра" на 1 месяц. Указание ваших\n' +
    ...
    },
    {
      title: 'Средний тариф',
      price: '20000',
      text: 'Какой-то текст, который будет отображаться в качестве описания предложенного рекламного тарифа',
      type: ''
    },
    {
      title: 'Умеренный тариф',
      price: '15000',
      text: 'Какой-то текст, который будет отображаться в качестве описания предложенного рекламного тарифа',
      type: ''
    },
    {
      title: 'Минимальный тариф',
      price: '10000',
      text: 'Какой-то текст, который будет отображаться в качестве описания предложенного рекламного тарифа',
      type: ''
    }
  ...
  return (
    <section>
      ...
      <div className="adv_container">
        <p>
          Ниже представлены основные рекламные предложения, которыми вы можите воспользоваться в случае необходимости
        </p>
        {rate.map((el, i) => {
