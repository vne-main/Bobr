...
const Advertising = () => {
  ...
  const rate = [
    ...
    },
    {
      ...
      price: "20000",
      text:
        "Какой-то текст, который будет отображаться в качестве описания предложенного рекламного тарифа",
      type: ""
    },
    {
  ...
  return (
    <section>
      ...
      <div className="adv_container">
        <p>
          Ниже представлены основные рекламные предложения, которыми вы можите
